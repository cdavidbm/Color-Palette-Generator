...
# crea un diccionario de colores únicos con la cuenta de cada color a 0
# incrementa la cuenta en 1 si existe en el diccionario
...
# Obtener  lista de las diez principales ocurrencias/cuentas de colores
# del diccionario de colores únicos
